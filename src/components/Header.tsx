const Header = () => {
  return (
    <header className="sticky top-0 z-50 pt-4 pb-4 pl-8 pr-8 w-full flex justify-between items-center bg-gray-300 rounded-b-xl max-md:flex-col gap-2 shadow-sm">
      <div>
